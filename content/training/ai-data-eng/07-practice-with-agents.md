...
description: "Practice function calling and tools vs plain chat: copy Cortex functions and agent prompts you can run today."
level: "beginner"
order: 7
durationMinutes: 25
...
Each practice card is a **function example**: name, arguments, when to use, and a copyable snippet. The **Try it** boxes (copy to practice) and cheat sheet above are those cards.
