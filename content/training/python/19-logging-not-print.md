...
description: "Structured logs are how Jobs, Tasks, and Airflow show rows_in / rows_out. print goes to a notebook and dies. Practice metrics in the local lab."
level: beginner
order: -1
durationMinutes: 25
topics: [python]
...
cheatSheet:
  - label: "Job-shaped logger"
    ...
    note: "getLogger(name) so Databricks / Airflow can route it. Run the metrics sample in the local lab."
...
Run the metrics sample in the **local practice lab**. The ETL builder lesson stays copy-to-repo.
