...
Local Practice Lab (DuckDB) is on **day-0 / lakehouse / warehouse** lessons — not a live workspace. These samples are copy-to-practice cards. Jump to [lakehouse fundamentals](/training/databricks/dbx-lakehouse-fundamentals#lab) to run SELECT-shaped gold.
